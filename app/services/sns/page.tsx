...
export const metadata: Metadata = {
  ...
  description:
    "個人サロン・地域事業者のためのSNS運用代行。立ち上げ期 月¥18,000~。Instagram メイン。",
};
    ...
    <>
      ...
      <FeaturesSection
        ...
        features={[
          ...
          },
          {
            ...
            title: "画像・リール制作",
            body: "お店の世界観に合わせた画像構成・配色・トーン統一。リールも対応可能です。",
          },
          {
      ...
      <FAQSection
        faqs={[
          {
            q: "投稿頻度はどのくらいですか?",
            a: "月8〜12本のフィード投稿+週1-2本のストーリーズ+月2本のリール、を標準としています。お店の状況に合わせて調整可能です。",
          },
          {
            q: "写真撮影は誰がするのですか?",
          ...
          {
            q: "リールは何本まで作れますか?",
            a: "30秒以内のリールを月2本まで料金内で対応します。素材(動画クリップ・写真)は、こちらで構成のうえご提案します。",
          },
          {
